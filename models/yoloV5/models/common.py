...
from models.yoloV5.utils.dataloaders import exif_transpose, letterbox
...
from models.yoloV5.utils.torch_utils import copy_attr, time_sync
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights='yolov5s.pt', device=torch.device('cpu'), dnn=False, data=None, fp16=False):
        ...
        from models.yoloV5.models.experimental import attempt_download, attempt_load  # scoped to avoid circular import
    ...
    def model_type(p='path/to/model.pt'):
        ...
        from models.yoloV5.export import export_formats

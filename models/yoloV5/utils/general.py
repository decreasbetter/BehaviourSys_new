...
from overLook.yoloV5.utils.downloads import gsutil_getsize
from overLook.yoloV5.utils.metrics import box_iou, fitness
...
def non_max_suppression(prediction,
    ...
    for xi, x in enumerate(prediction):  # image index, image inference
        ...
        if (time.time() - t) > time_limit:
            logger.warning("time out saveConf", saveConf)
